...
contract GovernorAlpha {
    ...
    string public constant name = "Draswap Governor Alpha";
    ...
    /// @notice The address of the Draswap Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the Draswap governance token
