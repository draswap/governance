...
import DraswapV2Factory from '@draswap/v2-core/build/DraswapV2Factory.json'
import DraswapV2Pair from '@draswap/v2-core/build/DraswapV2Pair.json'
...
describe('scenario:FeeTo', () => {
  ...
  beforeEach('deploy draswap v2', async () => {
    factory = await deployContract(wallet, DraswapV2Factory, [wallet.address])
  })
  ...
  describe('tokens', () => {
    ...
    beforeEach('create fee liquidity', async () => {
      ...
      pair = new Contract(pairAddress, DraswapV2Pair.abi).connect(wallet)
